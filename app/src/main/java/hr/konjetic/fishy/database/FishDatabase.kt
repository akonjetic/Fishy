...
@Database(entities = [FavoriteFish::class, FavoriteFishFamily::class, FavoriteWaterType::class, FavoriteHabitat::class, Aquarium::class, AquariumFish::class], version = 6, exportSchema = false)
